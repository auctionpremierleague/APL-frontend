...
export default function App() {
    ...
    useEffect(() => { 
        const fetchMatch = async () => {
            try {
                var response = await axios.get(`/match/matchinfo/1`);
    ...
    function ShowCurrentTable() {
        if (currentArray.length > 0) 
            ...
            return (
                <Card profile>
                <CardBody profile>
                    <h3 className={classes.cardTitle}>Currently no match running</h3>
                </CardBody>
                </Card>
            )
    }
    ...
    function ShowUpcomingTable() {
        ...
        return (
            ...
            return (
                <Card profile>
                <CardBody profile>
                    <h3 className={classes.cardTitle}>ALl Matches over</h3>
                </CardBody>
                </Card>    
            )
